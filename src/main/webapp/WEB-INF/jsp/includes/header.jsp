...
<head>
    ...
    <%--BOOTSTRAP--%>
    <c:url value="/webjars/bootstrap/4.0.0/js/bootstrap.min.js" var="bootstrapJS"/>
    ...
    <%--CUSTOM CSS--%>
    <c:url value="/static/css/applicationlab.css" var="bootstrapCUSTOM" />
    <link href="${bootstrapCUSTOM}" rel="stylesheet" media="screen" />

    <title>Vehicle Application Lab</title>
